...
public class GmailUtil {
	...
	public Email getEmail(Message message) {
		...
		if (StringUtils.isEmpty(email.getHtml()) && !StringUtils.isEmpty(email.getPlainText())) {
			email.setHtml(translateToHtml(email.getPlainText()));
		}
	...
	private String translateToHtml(String plainText) {
	...
	private String getHtmlBody(Message message) {
        ...
        String sanitzedBody = HtmlUtil.stripTitle(body);
        
        System.err.println("HTML is " + sanitzedBody + " \n\n\n\n");
	...
	private String getPlainText(Message message) {
        ...
        System.err.println("Plain text is " + body + " \n\n\n");
